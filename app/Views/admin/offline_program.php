                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Offline Program</li>
                                </ol>
                            </div>
                        </div>
                    </div>
								...
								<tbody>
									...
									<tr>
										...
										<?php if(in_array('2',$other_action)){ ?>
											<a href="#" class="edit-program" data-id="<?=$prg->id?>" data-title="<?=$prg->category;?>" data-toggle="modal" data-target="#editProgram"><i class="ti-pencil-alt" aria-hidden="true"></i></a>
										<?php } ?>
										</td>
                                    </tr>
									<?php } ?>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12 attach-details">
						<form class="form-submit" method="post" action="<?= site_url('content/update_offline_program')?>">
							<div class="row">
	...
	<div class="modal-dialog modal-lg modal-full">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12 attach-details">
						<form class="form-submit" method="post" action="<?= site_url('content/add_offline_program')?>">
							<div class="row">
								<div class="col-md-12 form-group" >
									<label>Title</label>
							...
							<div class="row">
								<div class="col-md-12 form-group">
									<button type="submit" class="btn btn-success form-control">Add Program</button>
								</div>
							</div>
						</form>
					</div>
        ...
        $( function() {
			...
			$('.change-status').on('click', function(){
				...
				if(item != "" && status != "")
				{
					...
					$.ajax({
						type: "POST",
						url: "<?= site_url('content/change_offline_program_status'); ?>",
