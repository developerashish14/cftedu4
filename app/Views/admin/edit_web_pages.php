            ...
            <div class="container-fluid">
                ...
                <section id="main-content">
                    <div class="card">
                        ...
                        <div class="card-body">
							<form class="form-submit" action="<?= site_url('web-admin/web_pages/update_page'); ?>" method="post">
								<div class="row">
									<div class="col-md-6 form-group">
										<label> Heading</label>
										<p><input class="form-control" type="text" name="heading" value="<?= $page_info->page_heading; ?>"></p>
									</div>
								
									<div class="col-md-6 form-group">
										<label> Title</label>
										<p><input class="form-control" type="text" name="title" value="<?= $page_info->title; ?>"></p>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6 form-group">
										<label> Keyword</label>
										<p><input class="form-control" type="text" name="keyword" value="<?= $page_info->keyword; ?>"></p>
									</div>
									<div class="col-md-6 form-group">
										<label> Description</label>
										<p><input class="form-control" type="text" name="description" value="<?= $page_info->description; ?>"></p>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6 form-group">
										<label> URL  (After Domain | without: space | without: any special charector )</label>
										<p><input class="form-control" type="text" name="url" value="<?= $page_info->page_url; ?>"></p>
									</div>
									<div class="col-md-6 form-group">
								...
								<div class="row">
									<div class="col-md-12 form-group">
										...
										<p><img id="display-img" src="<?= web_url(); ?>images/<?= $images[$page_info->banner_img]->location; ?>" style="width:100%;height:200px;"><input type="hidden" name="image_id" value="<?= $page_info->banner_img; ?>"></p>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12 form-group">
										<label> Content</label>
										<p><textarea id="main-content-text" class="form-control" name="content" style="height: 200px;" ><?= $page_info->main_content; ?></textarea></p>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12 form-group">
										<label> Header Script Option</label>
										<p><textarea class="form-control" name="header_script" style="height: 200px;" ><?= $page_info->header_text; ?></textarea></p>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12 form-group">
										<label> Footer Script Option</label>
										<p><textarea class="form-control" name="footer_script" style="height: 200px;" ><?= $page_info->footer_text; ?></textarea></p>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12 form-group">
										...
										<button type="submit" class="btn btn-success" style="width: 100%;"> <span class="btn-val">Update Page</span></button>
									</div>
								</div>
							</form>
						...
						<div class="row">
							<div class="col-sm-12">
								<ul class="media-list1">
									...
									<li>
										<label class="m-b-0"> <input type='radio' value='<?= $img->id; ?>' name='imgradio'/> <img class="img-select" data-id="<?= $img->id; ?>" src='<?= web_url(); ?>images/<?= $img->location; ?>' class='single-image'/> </label>
									</li>
									<?php } ?>
								</ul>
							</div>
