                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">CFT Certificate</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <section id="main-content">
                    <div class="card">
                        <div class="card-header m-b-20">
                           <div class="card-header m-b-20">
								<div class="row">
									<form action="<?=site_url('cft_certificate');?>" method="post">
										<div class="col-md-2">
								...
								<tbody>
									...
									<tr>
										...
										<?php if(in_array('3',$other_action)){ ?>
											<a href="#" onclick="window.open('<?=base_url("certificate/cft_view/".$cer->id);?>', 'MsgWindow', 'width=1024,height=540');"><i class="ti-eye" aria-hidden="true"></i></a>
										<?php } ?>
										</td>
                                    </tr>
									<?php } ?>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12 attach-details">
						<form class="form-submit" method="post" action="<?= site_url('certificate/cft_update_certificate')?>">
							<div class="row">
	...
	<div class="modal-dialog modal-lg modal-full">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12 attach-details">
						<form class="form-submit" method="post" action="<?= site_url('certificate/cft_add_certificate')?>">
							<div class="row">
								<div class="col-md-6 col-sm-12 form-group" >
									<label>Serial No</label>
	...
	<div class="modal-dialog modal-lg modal-full">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12 attach-details">
						<form class="form-submit" method="post" action="<?= site_url('certificate/cft_upload_certificate')?>" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-6 col-sm-12 form-group" >
        ...
        $( function() {
			...
			$('.change-status').on('click', function(){
				...
				if(item != "" && status != "")
				{
					...
					$.ajax({
						type: "POST",
						url: "<?= site_url('certificate/cft_send_certificate_email'); ?>",
