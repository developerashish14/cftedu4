                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table f-s-13">
                                ...
                                <tbody>
                                    <?php $i=1; foreach($team as $tm){ ?>
									<form class="form-submit" action="<?= site_url('gadget/update_team'); ?>" method="post">
										<tr>
											<td><?= $i++; ?></td>
											<td style="display:grid;">
												<label style="margin-bottom: -10px;font-size: 15px;">Size: 260x290</label>
												<img id="profile-img-<?=$i;?>" src="<?=web_url();?>/images/<?=$images[$tm->img]->location;?>" width="100px">
												<label>
											...
											<td id="team-<?=$tm->id?>">
												...
												<input type="hidden" class="form-control" name="team_id" value="<?= $tm->id; ?>">
					...
					<div id="mediaadd" class="tab-pane fade in active">
						<div class="row">
							<div class="col-sm-12 attach-details">
								<form class="form-submit" method="post" action="<?= site_url('gadget/add_team')?>">
									<div class="row">
        ...
        $( function() {
			...
			$('.change-status').on('click', function(){
				...
				if(item != "" && status != "")
				{
					...
					$.ajax({
						type: "POST",
						url: "<?= site_url('gadget/change_team_status'); ?>",
